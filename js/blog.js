...
let blogName = "Joryn's Thoughts";
let authorName = "Joryn";
...
[ "post/2021-03-20-welcome.html"],
["post/2020-11-10-test.html"]
];
...
let footerHTML = "<hr><p>" + blogName + " was created by " + authorName + " with love";



//To do the following stuff, we want to know where we are in the posts array (if we're currently on a post page).
let currentIndex = -1;
let currentFilename = url.substring(url.lastIndexOf('post/'));
